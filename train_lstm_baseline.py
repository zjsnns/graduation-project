...
class MultiStepLSTMBaseline(nn.Module):
    def __init__(
        self,
        input_dim: int,
        hidden_size: int,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Strict dynamic-cleaning LSTM baseline (same split/normalization protocol)."
    )
    ...
    parser.add_argument("--output_root", type=str, default=str(SCRIPT_DIR / "lstm_runs_strict_baseline"))
...
def save_run_config(
    ...
    lines = [
        ...
        f"device={device}",
        f"baseline_name=strict_lstm_baseline",
        ...
        f"nhead={args.nhead}  # unused in LSTM, kept for config compatibility",
